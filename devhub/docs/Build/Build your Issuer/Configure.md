...
You can find example test private DS keys and certificates, for country Utopia (UT) [here](https://github.com/eu-digital-identity-wallet/eudi-srv-web-issuing-eudiw-py/blob/main/api_docs/test_tokens/DS-token) - the password of the example test private DS keys is b"pid-ds-0002".
